...
public:
    ...
    // Address: 0x022AB1BC
    static bool createPlayerEffect(s32 player_no, LevelEffect* effect, EffectID id, const sead::Vector3f& trans, const sead::Vector3u& rotat, const sead::Vector3f& scale);
    // Address: 0x022AB224
    static bool createPlayerEffect(s32 player_no, LevelEffect* effect, EffectID id, const sead::Matrixf& mtx, bool mtx_has_scale);

    // Address: 0x022AB288
    static bool createPlayerEffect(s32 player_no, FollowEffect* effect, EffectID id, const sead::Vector3f& trans, const sead::Vector3u& rotat, const sead::Vector3f& scale);
    // Address: Deleted
