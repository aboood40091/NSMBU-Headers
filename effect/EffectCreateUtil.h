...
public:
    ...
    // Address: 0x022AB1BC
    static bool createPlayerEffect(s32 player_no, LevelEffect* p_effect, EffectID id, const sead::Vector3f* p_trans = nullptr, const Angle3* p_angle = nullptr, const sead::Vector3f* p_scale = nullptr);
    // Address: 0x022AB224
