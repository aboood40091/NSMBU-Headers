...
public:
    ...
    // Address: 0x023DD708
    static JointBlendModel* createModel(ModelResource* p_mdl_res, const sead::SafeString& name, bool not_set_walk_anm);
...
protected:
    // Address: 0x023DC4AC
    void calcModelBase_(JointBlendModel* p_blend_model);
